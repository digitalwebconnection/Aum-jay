...
const ContactForm = () => {
  ...
  return (
    <div id="contact" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-green-100 p-6">
      <motion.div
        initial={{ opacity: 0, y: 40 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="w-full max-w-2xl backdrop-blur-md bg-white/80 shadow-2xl rounded-2xl p-8 border border-green-100"
      >
        <motion.h2
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 shadow-sm">
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 bg-white border border-green-300 rounded-md text-center py-1 font-mono text-xl font-bold tracking-widest text-green-700 shadow-inner">
                {captchaCode}
              </div>
              <input
                type="text"
                ...
                required
                className="flex-1 px-3 py-2 border border-green-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 uppercase"
    ...
    <div className="relative">
      ...
      {type === "textarea" ? (
        <textarea
          ...
          required={required}
          className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:outline-none"
        />
      ) : (
        <input
          type={type}
  ...
  <div>
    ...
    <div className="relative">
      ...
      <select
        ...
        value={value}
        onChange={onChange}
        className="w-full pl-10 pr-3 py-1 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:outline-none"
      >
