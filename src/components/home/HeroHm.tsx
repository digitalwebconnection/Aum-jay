  ...
  return (
    <>
      ...
      >
        ...
        {/* Keyframes */}
        <style>{`
          @keyframes kenburns { 0%{transform:scale(1.1)}50%{transform:scale(1.22) translate(-3%,-3%)}100%{transform:scale(1.1)} }
          .animate-kenburns { animation: kenburns 12s ease-in-out infinite; }
          @keyframes grainMove {0%{transform:translate(-10%,-10%)}100%{transform:translate(0,0)}} 
          ...
          @keyframes fade-in {from{opacity:0}to{opacity:1}} .animate-fade-in{animation:fade-in 1.6s ease-in forwards;}
          @keyframes gradient-x {0%{background-position:0% 50%}50%{background-position:100% 50%}100%{background-position:0% 50%}}
          .animate-gradient-x{background-size:200% 200%;animation:gradient-x 7s ease infinite;}
          @keyframes pulse-glow {0%,100%{box-shadow:0 0 8px rgba(255,197,39,0.55);}50%{box-shadow:0 0 16px rgba(255,197,39,0.9);}}
          .animate-pulse-glow{animation:pulse-glow 2s infinite alternate;}
        `}</style>
      </section>

      {/* ✅ Popup visible on button click */}
      ...
      <svg viewBox="0 0 512 512" className="h-full w-full">
        <defs>
          <radialGradient id="sunCore" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#FFC527" stopOpacity="0.95" />
            <stop offset="55%" stopColor="#FFE27A" stopOpacity="0.55" />
            <stop offset="100%" stopColor="#FFC527" stopOpacity="0" />
          </radialGradient>
          <linearGradient id="sunRay" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#FFC527" stopOpacity="0.95" />
            <stop offset="100%" stopColor="#0DB02B" stopOpacity="0.0" />
          </linearGradient>
        </defs>
